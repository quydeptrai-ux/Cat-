...
if _G.Cat_Hub_Series_R then
	...
	if getgenv().Deleted_Ui then
		...
		if game:GetService("CoreGui"):FindFirstChild('Cat Hub') then
			game:GetService("CoreGui"):FindFirstChild('Cat Hub'):Destroy()
		end
		-- Cat Hub
		local Cat_Hub = Instance.new("ScreenGui")
		Cat_Hub.Name = "Cat Hub"
		Cat_Hub.Parent = game:GetService("CoreGui")
		Cat_Hub.Enabled = false
		...
		F_Level.Name = "Level"
		F_Level.Parent = game:GetService("CoreGui")["Cat Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Cat Hub"].Level
		game:GetService("CoreGui")["Cat Hub"].Level.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		game:GetService("CoreGui")["Cat Hub"].Level.Fragments.Text = "Cat Hub"
		game:GetService("CoreGui")["Cat Hub"].Level.Fragments.Size = UDim2.new(1, 0, 0, 40)
		game:GetService("CoreGui")["Cat Hub"].Level.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Cat Hub"].Level.Position = UDim2.new(0.5, 0, -0.2, 0)
		game:GetService("CoreGui")["Cat Hub"].Level.Fragments.TextStrokeTransparency = 1
		
		-- Time
		local F_Text2 = Instance.new("Frame")
		F_Text2.Name = "Text2"
		F_Text2.Parent = game:GetService("CoreGui")["Cat Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Cat Hub"].Text2
		game:GetService("CoreGui")["Cat Hub"].Text2.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["Cat Hub"].Text2.Fragments.Text = ""
		game:GetService("CoreGui")["Cat Hub"].Text2.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["Cat Hub"].Text2.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Cat Hub"].Text2.Position = UDim2.new(0.5, 0, -0.1, 0)
		game:GetService("CoreGui")["Cat Hub"].Text2.Fragments.TextStrokeTransparency = 1
		
		-- Name
		local F_Text = Instance.new("Frame")
		F_Text.Name = "Text"
		F_Text.Parent = game:GetService("CoreGui")["Cat Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Cat Hub"].Text
		game:GetService("CoreGui")["Cat Hub"].Text.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["Cat Hub"].Text.Fragments.Text = '( '..game.Players.LocalPlayer.Name..' )'
		game:GetService("CoreGui")["Cat Hub"].Text.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["Cat Hub"].Text.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Cat Hub"].Text.Position = UDim2.new(0.5, 0, 0.14, 0)
		game:GetService("CoreGui")["Cat Hub"].Text.Fragments.TextStrokeTransparency = 1
		-- Status
		local F_Text3 = Instance.new("Frame")
		F_Text3.Name = "Text3"
		F_Text3.Parent = game:GetService("CoreGui")["Cat Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Cat Hub"].Text3
		game:GetService("CoreGui")["Cat Hub"].Text3.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		game:GetService("CoreGui")["Cat Hub"].Text3.Fragments.Text = 'Status: Farm Level.'
		game:GetService("CoreGui")["Cat Hub"].Text3.Fragments.Size = UDim2.new(1, 0, 0, 28)
		game:GetService("CoreGui")["Cat Hub"].Text3.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Cat Hub"].Text3.Position = UDim2.new(0.5, 0, 0.22, 0)
		game:GetService("CoreGui")["Cat Hub"].Text3.Fragments.TextStrokeTransparency = 1
		-- Item Sanguine Art
		local F_Text5 = Instance.new("Frame")
		F_Text5.Name = "Text5"
		F_Text5.Parent = game:GetService("CoreGui")["Cat Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Cat Hub"].Text5
		game:GetService("CoreGui")["Cat Hub"].Text5.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["Cat Hub"].Text5.Fragments.Text = '...'
		game:GetService("CoreGui")["Cat Hub"].Text5.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["Cat Hub"].Text5.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Cat Hub"].Text5.Position = UDim2.new(0.5, 0, 0.38, 0)
		game:GetService("CoreGui")["Cat Hub"].Text5.Fragments.TextStrokeTransparency = 1
		-- Full Moon
		local F_Text6 = Instance.new("Frame")
		F_Text6.Name = "Text6"
		F_Text6.Parent = game:GetService("CoreGui")["Cat Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Cat Hub"].Text6
		game:GetService("CoreGui")["Cat Hub"].Text6.Fragments.TextColor3 = Color3.fromRGB(255,140,0)
		game:GetService("CoreGui")["Cat Hub"].Text6.Fragments.Text = '🌕 75% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
		game:GetService("CoreGui")["Cat Hub"].Text6.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["Cat Hub"].Text6.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Cat Hub"].Text6.Position = UDim2.new(0.5, 0, -0.03, 0)
		game:GetService("CoreGui")["Cat Hub"].Text6.Fragments.TextStrokeTransparency = 1
		spawn(function()
			while wait(1) do
				pcall(function()
					if Three_World then
						if game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149431" then
							game:GetService("CoreGui")["Cat Hub"].Text6.Fragments.Text = '🌕 100% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149052" then
							game:GetService("CoreGui")["Cat Hub"].Text6.Fragments.Text = '🌕 75% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709143733" then
							game:GetService("CoreGui")["Cat Hub"].Text6.Fragments.Text = '🌕 50% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709150401" then
							game:GetService("CoreGui")["Cat Hub"].Text6.Fragments.Text = '🌕 25% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149680" then
							game:GetService("CoreGui")["Cat Hub"].Text6.Fragments.Text = '🌕 15% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						else 
							game:GetService("CoreGui")["Cat Hub"].Text6.Fragments.Text = '🌕 0% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						end 
						...
						game:GetService("CoreGui")["Cat Hub"].Text2.Fragments.Text = tempo
					else
						game:GetService("CoreGui")["Cat Hub"].Text6.Fragments.Text = '🌕 0% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						local scripttime=game.Workspace.DistributedGameTime
						local seconds = scripttime%60
		...
		F_Text4.Name = "Text4"
		F_Text4.Parent = game:GetService("CoreGui")["Cat Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Cat Hub"].Text4
		game:GetService("CoreGui")["Cat Hub"].Text4.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		game:GetService("CoreGui")["Cat Hub"].Text4.Fragments.Text = '...'
		game:GetService("CoreGui")["Cat Hub"].Text4.Fragments.Size = UDim2.new(1, 0, 0, 35)
		game:GetService("CoreGui")["Cat Hub"].Text4.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Cat Hub"].Text4.Position = UDim2.new(0.5, 0, 0.47, 0)
		game:GetService("CoreGui")["Cat Hub"].Text4.Fragments.TextStrokeTransparency = 1

		local BlurCat = Instance.new("BlurEffect")
		BlurCat.Name = "CatBlur"
		BlurCat.Parent = game:GetService("Lighting")
		BlurCat.Enabled = true
		BlurCat.Size = 0
		...
		game:GetService("UserInputService").InputBegan:Connect(function(input, isTyping)
			if not isTyping then
				if input.KeyCode == Enum.KeyCode.B then
					if togle_up then
						game:GetService("CoreGui")["Cat Hub"].Enabled = false
						game.Lighting.ExposureCompensation = 0
						--BlurCat.Size = 0
						togle_up = false
					else
						game:GetService("CoreGui")["Cat Hub"].Enabled = true
		...
		ToggleImgUi.Image = "rbxassetid://17425369757"
		...
		Yedhee.Text = "Click: [Close/Open Ui]"
		Yedhee.TextColor3 = Color3.fromRGB(0, 255, 186) 
		Yedhee.TextSize = 12.000
		
		if game.CoreGui:FindFirstChild('Cat Hub C') then
			game.CoreGui:FindFirstChild('Cat Hub C'):Destroy()
		end
		local function click(a)
			...
			repeat 
				for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main.InventoryContainer.Right.Content.ScrollingFrame.Frame:GetDescendants()) do
					if v.Name == 'Background' and tostring(v.BackgroundColor) == 'Bright red' and not table.find(keep_all_name,v.Parent.ItemName.Text) then 
						v.Parent:Clone().Parent = game:GetService("CoreGui")["Cat Hub C"][Folder]
						game:GetService("CoreGui")["Cat Hub C"][Folder][v.Parent.Name].Name = v.Parent.ItemName.Text
		...
		uig.Parent = game:GetService("CoreGui")["Cat Hub C"].FruitB
		...
		game:GetService("CoreGui")["Cat Hub C"].FruitB.Visible = true
		click(game:GetService("Players").LocalPlayer.PlayerGui.Main.MenuButton) -- open menu
		]]
		wait(.5)
		...
		function Set_Status_X(vu)
			game:GetService("CoreGui")["Cat Hub"].Text3.Fragments.Text = vu
		end
		--[[
		...
		Notify({
			...
			Title = "Cat Hub Kaitun | "..tostring(game.Players.LocalPlayer.Name),
			Duration = 5
		})
		Notify({
		...
		status_pass = Notification.new("message", 'Cat Hub Kaitun | ', "Status: ...")
		...
		_G.library = loadstring(game:HttpGet("https://raw.githubusercontent.com/quydeptrai-ux/Cat-/main/README%20(1).md"))()
		library = _G.library
	end
		...
		while wait(10) do
			pcall(function()
				...
				if ris_text ~= '' then
					...
					game:GetService("CoreGui")["Cat Hub"].Text4.Fragments.Text  = ris_text
				end
				local ris_text = ''
				if RGB_H then
					ris_text = 'RGB Aura'
				...
				game:GetService("CoreGui")["Cat Hub"].Text5.Fragments.Text = ris_text
				wait(300)
			end)
		end
	end)
